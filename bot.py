    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. https://t.me/MOTUMOVIES For Support")
                sys.exit()
        ...
        try:
            ...
            self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/MOTUMOVIES For Support")
            sys.exit()

        self.set_parse_mode(ParseMode.HTML)
        self.LOGGER(__name__).info(f"Bot Running...!\n\nCreated By \nhttps://t.me/MOTUMOVIES")
        self.LOGGER(__name__).info(f"""ミ💖 WR ROHIT02 💖彡""")
